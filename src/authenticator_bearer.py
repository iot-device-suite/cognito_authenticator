...
CLIENT_ID = "58cn4ra5bg54m30jnklhludn9n"
IDENTITY_POOL_ID = "eu-central-1:51e7519b-4b3b-4723-b356-7bec0273316d"
USER_POOL_PROVIDER_ID = "eu-central-1_u3YeXoQtL"

# print(CLIENT_ID)
# print(IDENTITY_POOL_ID)
# print(USER_POOL_PROVIDER_ID)
...
if __name__ == "__main__":
    ...
    auth_events = cognito_idp_client.admin_list_user_auth_events(
        UserPoolId=USER_POOL_PROVIDER_ID,
        Username=username
    )
